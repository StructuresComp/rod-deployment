...
setInput::setInput()
{
  ...
  AddOption("friction", "Coefficient of friction", pulltime);
	...
	AddOption("filename", "name of file", filename);
	AddOption("scale", "scale of EA", scale);

	AddOption("xTop", "top x coord", xTop);
	AddOption("yTop", "top y coord", yTop);
	AddOption("zTop", "top z coord", zTop);

	AddOption("kappaT", "target curvature", kappaT);
	AddOption("kappaI", "guess curvature", kappaI);
	AddOption("normKs", "normalized stretching stiffness", normKs);
